...
public class BlockSilverore extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:silverore")
	public static final Block block = null;
	public BlockSilverore(ElementsMbPlusMod instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("mb_plus:silverore", "inventory"));
	}
