...
public class BlockTransparentoakplanks extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:transparentoakplanks")
	public static final Block block = null;
	public BlockTransparentoakplanks(ElementsMbPlusMod instance) {
		super(instance, 52);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("mb_plus:transparentoakplanks", "inventory"));
	}
