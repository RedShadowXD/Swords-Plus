...
public class BlockTransparentjungleplanks extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:transparentjungleplanks")
	public static final Block block = null;
	public BlockTransparentjungleplanks(ElementsMbPlusMod instance) {
		super(instance, 56);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("mb_plus:transparentjungleplanks", "inventory"));
	}
