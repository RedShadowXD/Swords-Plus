...
import red.moreblocks.plus.item.ItemBerry;
...
public class BlockBerryBush extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:berry_bush")
	public static final Block block = null;
	public BlockBerryBush(ElementsMbPlusMod instance) {
		super(instance, 207);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("mb_plus:berry_bush", "inventory"));
	}
