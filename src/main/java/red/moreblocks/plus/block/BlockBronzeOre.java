...
public class BlockBronzeOre extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:bronze_ore")
	public static final Block block = null;
	public BlockBronzeOre(ElementsMbPlusMod instance) {
		super(instance, 2);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("mb_plus:bronze_ore", "inventory"));
	}
