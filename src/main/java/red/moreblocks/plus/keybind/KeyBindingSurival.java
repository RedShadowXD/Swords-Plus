...
import red.moreblocks.plus.procedure.ProcedureSurivalOnKey;
...
public class KeyBindingSurival extends ElementsMbPlusMod.ModElement {
	private KeyBinding keys;
	public KeyBindingSurival(ElementsMbPlusMod instance) {
		super(instance, 202);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.surival", Keyboard.KEY_F6, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureSurivalOnKey.executeProcedure($_dependencies);
		}
	}
}
