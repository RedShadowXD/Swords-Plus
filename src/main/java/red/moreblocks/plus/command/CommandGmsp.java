...
import red.moreblocks.plus.procedure.ProcedureGmspCommandExecuted;
...
public class CommandGmsp extends ElementsMbPlusMod.ModElement {
	public CommandGmsp(ElementsMbPlusMod instance) {
		super(instance, 256);
	}
