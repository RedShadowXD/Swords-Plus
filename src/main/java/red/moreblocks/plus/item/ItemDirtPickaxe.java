...
public class ItemDirtPickaxe extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:dirt_pickaxe")
	public static final Item block = null;
	public ItemDirtPickaxe(ElementsMbPlusMod instance) {
		super(instance, 11);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("mb_plus:dirt_pickaxe", "inventory"));
	}
}
