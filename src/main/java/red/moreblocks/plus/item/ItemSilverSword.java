...
public class ItemSilverSword extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:silver_sword")
	public static final Item block = null;
	public ItemSilverSword(ElementsMbPlusMod instance) {
		super(instance, 23);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("mb_plus:silver_sword", "inventory"));
	}
}
