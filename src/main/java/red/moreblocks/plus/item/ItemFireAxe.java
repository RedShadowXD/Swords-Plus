...
public class ItemFireAxe extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:fire_axe")
	public static final Item block = null;
	public ItemFireAxe(ElementsMbPlusMod instance) {
		super(instance, 32);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("mb_plus:fire_axe", "inventory"));
	}
