...
public class ItemObsidianHoe extends ElementsMbPlusMod.ModElement {
	@GameRegistry.ObjectHolder("mb_plus:obsidian_hoe")
	public static final Item block = null;
	public ItemObsidianHoe(ElementsMbPlusMod instance) {
		super(instance, 30);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("mb_plus:obsidian_hoe", "inventory"));
	}
}
