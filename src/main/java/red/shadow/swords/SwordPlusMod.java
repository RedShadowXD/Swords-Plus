 ...
 *
 *    Keep the ElementsSwordPlusMod object in this class and all calls to this object
...
public class SwordPlusMod {
	...
	@Mod.Instance(MODID)
	public static SwordPlusMod instance;
	public ElementsSwordPlusMod elements = new ElementsSwordPlusMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsSwordPlusMod.GuiHandler());
