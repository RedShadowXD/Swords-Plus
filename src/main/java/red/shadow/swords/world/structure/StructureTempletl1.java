...
package red.shadow.swords.world.structure;
...
public class StructureTempletl1 extends ElementsSwordPlusMod.ModElement {
	public StructureTempletl1(ElementsSwordPlusMod instance) {
		super(instance, 34);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("sword_plus", "light_temple_tl1"));
				if (template == null)
					return;
